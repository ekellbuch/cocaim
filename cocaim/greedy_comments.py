    ...
    while rerun_1:
        ...
        if residual.max() >= residual_min_threshold:
            ...
            if np.abs(s_r.max()) <= residual_min_threshold:
                ...
                #keep2_r = find_spatial_component(U_r)
                #keep1_r = np.intersect1d(keep1_r,keep2_r)
                #print('977')
...
def denoise_components(data,
    ...
    #keep2 = find_spatial_component(U)
