...
def combine_4xd(nblocks,dW_,dW_rs,dW_cs,dW_rcs, plot_en=False):
    ...
    ## Get offset dims
    dims_ = offset_tiling_dims(dims,nblocks=nblocks,offset_case=None)[1]
    dims_rs = offset_tiling_dims(dims,nblocks=nblocks,offset_case='r')[1]
    dims_cs = offset_tiling_dims(dims,nblocks=nblocks,offset_case='c')[1]
    dims_rcs = offset_tiling_dims(dims,nblocks=nblocks,offset_case='rc')[1]
    ##
